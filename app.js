...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="list-item todo-block__item";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo-block__item_edit");
    ...
    listItem.classList.toggle("todo-block__item_edit");
};
